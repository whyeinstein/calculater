        ...
        for (int i = 0; i < input.size(); i++) {
            ...
            if (in[i] == '^')
            {
                if (i == 0 || i == input.size() - 1)
                {
                    ...
                    ui->lineEdit_3->setText("输入的算式不符合规范 39");
                    s = 0;
                    return;
                }
                ...
                for (int x = i - 1;; x--) {
                    ...
                    else if (in[x] == '+' || in[x] == '-' || in[x] == '*' || in[x] == '/' || in[x] == '(')
                    {
                        ...
                        ui->lineEdit_3->setText("输入的算式不符合规范 40");
                        s = 0;
                        return;
                    }
                }
                ...
                for (int x = i + 1;; x++) {
                    ...
                    else if (in[x] == '+' || in[x] == '-' || in[x] == '*' || in[x] == '/' || in[x] == ')')
                    {
                        ...
                        ui->lineEdit_3->setText("输入的算式不符合规范 41");
                        s = 0;
                        return;
                    }
                }
...
void MainWindow::on_compare_clicked()
{
    ...
    MainWindow::calclog();//对数函数

    MainWindow::calcpow();//幂函数
